...
When present, `SimulationContext.Jobs` can schedule normal or range jobs. The runtime tracks those handles and establishes an automatic fence at the end of each registered system invocation.
