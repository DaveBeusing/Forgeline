...
BenchmarkDotNet hosts cover the implemented ECS, hierarchical navigation, simulation, command-processing, job-scheduler, spatial-query, 1,000-unit ground-movement, and rendering foundations.
