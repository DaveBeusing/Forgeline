...
BenchmarkDotNet hosts cover the implemented ECS, hierarchical navigation, shared-versus-independent formation routing, simulation, command-processing, job-scheduler, spatial-query, 1,000-unit ground-movement, 100/1,000/10,000-pair resource extraction, 100/1,000/10,000-operation inventory transfer batches, and rendering foundations.
