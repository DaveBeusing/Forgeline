...
See [Combat Orders, Tactical Behavior, and Readiness](docs/CombatOrdersAndReadiness.md) for Attack/AttackMove/Stop/Hold/Retreat semantics, pursuit leashes, group target assignment, automatic resupply decisions, unit/group readiness, tactical test-opponent constraints, diagnostics, and load benchmarks.
